                        ...
                        <div class="row g-0">
                            <div class="col-12 col-md-6 d-none d-md-block">
                                <img class="img-fluid rounded-start w-80 h-80 object-fit-cover" loading="lazy"
                                    src="{{ asset('assets/img/img_2.jpg') }}" alt="Welcome back you've been missed!">
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-5">
                                                    ...
                                                    {{-- <h4 class="text-center">¡Bienvenido nuevamente, te extrañamos!</h4> --}}
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div class="row">
                                        ...
                                        @if (session('message'))
                                            <div class="mt-2">
                                                <small class="text-danger d-block">
                                                    <i
                                                        class="fa-solid fa-circle-exclamation me-1"></i>{{ session('message') }}
                                                </small>
                                            </div>
                                        @endif
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div
                                                    ...
                                                    <a href="{{ route('login/formUser') }}"
                                                        class="link-secondary text-decoration-none">Crear
                                                        cuenta</a>
                                                    <a href="#!" class="link-secondary text-decoration-none">Olvidaste
                                                        tu contraseña</a>
                                                </div>
                                            </div>
                                        </div>
